            ...
            <div className="grid grid-cols-1 gap-4">
              ...
              <div>
                ...
                <input
                  ...
                  placeholder="Choisissez dans la liste ou tapez le nom de votre quartier"
                  className="w-full px-3 py-2 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500"
                />
                <datalist id="lieu1-options">
                  {allQuartiers.map((loc) => (
              ...
              <div>
                ...
                <input
                  ...
                  placeholder="Choisissez dans la liste ou tapez le nom du lieu"
                  className="w-full px-3 py-2 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500"
                />
                <datalist id="lieu2-options">
                  {allQuartiers.map((loc) => (
                    <option key={loc.code} value={loc.name} />
                  ))}
                </datalist>
              ...
              <div>
                ...
                <input
                  type="text"
                  list="sous-prefecture-options"
                  value={formData.sousPrefecture || ""}
                  onChange={(e) => handleInputChange("sousPrefecture", e.target.value)}
                  placeholder="Choisissez dans la liste ou tapez le nom de la sous-préfecture"
                  className="w-full px-3 py-2 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500"
                />
                <datalist id="sous-prefecture-options">
                  {allSousPrefectures.map((loc) => (
                    <option key={loc.code} value={loc.name} />
                  ))}
                </datalist>
              </div>
