...
export function FloatingGuideIA() {
  ...
  return (
    <>
      {/* ── Bouton — cercle + texte à côté pour rester compréhensible, reste dans le
          pied de page, ne flotte plus sur le reste du site ── */}
      <button
        aria-label="Assistant IA - Guide du site"
        onClick={() => setOpen(o => !o)}
        className="inline-flex items-center gap-1.5 transition-all hover:scale-105 active:scale-95 select-none"
      >
        <span
        ...
        <span className="text-[11px] font-semibold text-white">Guide IA</span>
      </button>
