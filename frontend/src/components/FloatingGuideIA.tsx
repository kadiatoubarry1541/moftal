  ...
  return (
    <>
      ...
      <button
        ...
        onClick={() => setOpen(o => !o)}
        className="flex flex-col items-center justify-center gap-0 rounded-full w-5 h-5 text-[4px] font-semibold text-white transition-all hover:scale-105 active:scale-95 select-none"
        style={{
