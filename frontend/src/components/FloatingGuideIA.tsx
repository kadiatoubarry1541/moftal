  ...
  return (
    <>
      ...
      <button
        ...
        onClick={() => setOpen(o => !o)}
        className="flex flex-col items-center justify-center gap-0.5 rounded-full w-14 h-14 text-[9px] font-semibold text-white transition-all hover:scale-105 active:scale-95 select-none"
        style={{
