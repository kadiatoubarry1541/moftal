  ...
  return (
    <>
      ...
      <button
        ...
        onClick={() => setOpen(o => !o)}
        className="flex flex-col items-center justify-center gap-0 rounded-full w-9 h-9 text-[6px] font-semibold text-white transition-all hover:scale-105 active:scale-95 select-none"
        style={{
