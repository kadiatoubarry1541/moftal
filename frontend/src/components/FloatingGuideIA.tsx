...
export function FloatingGuideIA() {
  ...
  return (
    <>
      {/* ── Bouton — icône au-dessus du texte (empilés) pour se rapprocher d'un cercle
          plutôt qu'une pilule allongée, tout en gardant "Guide IA" lisible dedans ── */}
      <button
        aria-label="Assistant IA - Guide du site"
        onClick={() => setOpen(o => !o)}
        className="flex flex-col items-center justify-center gap-0 shrink-0 rounded-full w-7 h-7 text-[5px] leading-none font-semibold text-white transition-all hover:scale-105 active:scale-95 select-none overflow-hidden"
        style={{
      ...
      >
        <svg xmlns="http://www.w3.org/2000/svg" width={11} height={11} fill="none" viewBox="0 0 24 24" stroke="white" strokeWidth={2}>
          <path strokeLinecap="round" strokeLinejoin="round" d="M8.228 9c.549-1.165 2.03-2 3.772-2 2.21 0 4 1.343 4 3 0 1.4-1.278 2.575-3.006 2.907-.542.104-.994.54-.994 1.093m0 3h.01M21 12a9 9 0 11-18 0 9 9 0 0118 0z" />
        </svg>
        <span className="mt-[1px]">Guide IA</span>
      </button>
