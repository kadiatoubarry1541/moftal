...
export function FloatingGuideIA() {
  ...
  return (
    <>
      {/* ── Bouton — cercle, reste dans le pied de page, ne flotte plus sur le reste du site ── */}
      <button
        aria-label="Assistant IA - Guide du site"
        onClick={() => setOpen(o => !o)}
        className="inline-flex items-center justify-center rounded-full transition-all hover:scale-105 active:scale-95 select-none"
        style={{
          width: 32, height: 32,
