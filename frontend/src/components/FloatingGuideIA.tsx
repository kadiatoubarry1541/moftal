  ...
  return (
    <>
      ...
      <button
        ...
        onClick={() => setOpen(o => !o)}
        className="inline-flex items-center gap-1 rounded-full px-2 py-1 text-[10px] font-semibold text-white transition-all hover:scale-105 active:scale-95 select-none"
        style={{
      ...
      >
        <svg xmlns="http://www.w3.org/2000/svg" width={13} height={13} fill="none" viewBox="0 0 24 24" stroke="white" strokeWidth={2}>
