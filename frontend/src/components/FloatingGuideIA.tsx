...
export function FloatingGuideIA() {
  ...
  return (
    <>
      {/* ── Bouton — forme ronde, icône ET texte "Guide IA" dans le même bouton coloré ── */}
      <button
        aria-label="Assistant IA - Guide du site"
        onClick={() => setOpen(o => !o)}
        className="inline-flex items-center gap-1 rounded-full px-1.5 py-0.5 text-[9px] font-semibold text-white transition-all hover:scale-105 active:scale-95 select-none"
        style={{
