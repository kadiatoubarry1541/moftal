...
interface PublishedStory {
  id: number; numeroH: string; authorName: string; sectionId: string; sectionTitle: string;
  content: string; photos: string[]; videos: string[]; generation: string | null;
  region: string | null; country: string | null; publishedAt: string; views: number;
...
const HISTORICAL_DATA: HistoricalEntry[] = [
  { generation: 1, title: "Adam — Le Premier Homme", era: "Origines", icon: "🌿",
    ...
    figures: ["Adam (Prophète, père de l'humanité)", "Hawa/Ève (mère de l'humanité)"] },
  ...
  { generation: 2, title: "Hawa et les Premiers Enfants", era: "Origines", icon: "🌸",
    ...
    figures: ["Seth/Shayth (continuateur de la lignée)", "Énosch/Enos (petit-fils d'Adam)"] },
  ...
  { generation: 3, title: "Shayth et les Patriarches Premiers", era: "Patriarches Anciens", icon: "📿",
    ...
    figures: ["Méhaléel (patriarche)", "Jéred/Jared (père d'Idris)"] },
  ...
  { generation: 4, title: "Idris — Le Sage Écrivain", era: "Patriarches Anciens", icon: "✍️",
    ...
    figures: ["Idris/Hénoch (Prophète)", "Mathusalem (le plus âgé des hommes)"] },
  ...
  { generation: 5, title: "Mathusalem et la Longévité", era: "Patriarches Anciens", icon: "⏳",
    ...
    figures: ["Nuh/Noé (Prophète)", "Lamech (père de Noé)"] },
  ...
  { generation: 6, title: "Nuh — L'Arche et le Déluge", era: "Déluge", icon: "⛵",
    ...
    figures: ["Nuh/Noé (Prophète, constructeur de l'Arche)", "Sem, Cham, Japhet (fils de Noé)"] },
  ...
  { generation: 7, title: "Après le Déluge — Les Nations se Forment", era: "Déluge", icon: "🌈",
    ...
    figures: ["Arpachschad (fils de Sem)", "Cush (père des peuples africains)"] },
  ...
  { generation: 8, title: "La Tour de Babel et les Premières Cités", era: "Premières Civilisations", icon: "🏛️",
    ...
    figures: ["Nimrod (roi de Babylone)", "Héber (ancêtre des Hébreux)"] },
  ...
  { generation: 9, title: "Ibrahim — Le Chercheur de Vérité", era: "Prophètes Abrahamiques", icon: "⭐",
    ...
    figures: ["Abraham/Ibrahim (Prophète, père des nations)", "Térach (père d'Abraham)"] },
  ...
  { generation: 10, title: "Ibrahim — La Kaaba et le Sacrifice", era: "Prophètes Abrahamiques", icon: "🕋",
    ...
    figures: ["Ibrahim/Abraham (Prophète)", "Ismaël/Ismail (Prophète, ancêtre des Arabes)"] },
  ...
  { generation: 11, title: "Ishaq, Yaqoub et les Douze Tribus", era: "Prophètes Abrahamiques", icon: "🌟",
    ...
    figures: ["Isaac/Ishaq (Prophète)", "Jacob/Yaqub (Prophète, père des 12 tribus)"] },
  ...
  { generation: 12, title: "Youssouf — La Providence Divine", era: "Prophètes Abrahamiques", icon: "👑",
    ...
    figures: ["Joseph/Yusuf (Prophète)", "Imhotep (génie médical égyptien)"] },
  ...
  { generation: 13, title: "Musa — L'Exode et les Commandements", era: "Moïse et l'Exode", icon: "🔥",
    ...
    figures: ["Moïse/Musa (Prophète)", "Aaron/Harun (Prophète, frère de Moïse)"] },
  ...
  { generation: 14, title: "Josué et la Terre Promise", era: "Moïse et l'Exode", icon: "🏔️",
    ...
    figures: ["Josué (successeur de Moïse)", "Déborah (prophétesse et juge)"] },
  ...
  { generation: 15, title: "Samuel et le Royaume d'Israël", era: "Royaumes d'Israël", icon: "⚖️",
    ...
    figures: ["Samuel (Prophète et dernier juge)", "Saül (premier roi d'Israël)"] },
  ...
  { generation: 16, title: "Dawoud — Roi, Prophète et Psalmiste", era: "Royaumes d'Israël", icon: "🎵",
    ...
    figures: ["David/Dawud (Prophète)", "Abigaïl (femme sage et courageuse)"] },
  ...
  { generation: 17, title: "Souleyman — La Sagesse Royale", era: "Royaumes d'Israël", icon: "💎",
    ...
    figures: ["Salomon/Sulayman (Prophète)", "Reine de Saba/Balkis"] },
  ...
  { generation: 18, title: "Les Prophètes d'Israël et les Empires", era: "Royaumes d'Israël", icon: "🛡️",
    ...
    figures: ["Élie/Ilyas (Prophète)", "Élisée (Prophète, successeur d'Élie)"] },
  ...
  { generation: 19, title: "L'Exil à Babylone", era: "Royaumes d'Israël", icon: "😢",
    ...
    figures: ["Isaïe (Prophète)", "Jérémie (Prophète des larmes et de l'espoir)"] },
  ...
  { generation: 20, title: "Cyrus et le Retour d'Exil", era: "Empires Anciens", icon: "🦁",
    ...
    figures: ["Daniel (Prophète)", "Cyrus le Grand (roi libérateur)"] },
  ...
  { generation: 21, title: "L'Éveil Spirituel Mondial", era: "Empires Anciens", icon: "🌍",
    ...
    figures: ["Darius Ier (roi de Perse)", "Zoroastre (fondateur du zoroastrisme)"] },
  ...
  { generation: 22, title: "Confucius, Bouddha et les Sages d'Orient", era: "Empires Anciens", icon: "🪔",
    ...
    figures: ["Confucius (philosophe)", "Bouddha Siddhartha Gautama"] },
  ...
  { generation: 23, title: "La Grèce — Naissance de la Philosophie", era: "Empires Anciens", icon: "🏺",
    ...
    figures: ["Solon (père de la démocratie)", "Pythagore (mathématicien)"] },
  ...
  { generation: 24, title: "Périclès et l'Âge d'Or d'Athènes", era: "Empires Anciens", icon: "🏛️",
    ...
    figures: ["Périclès (homme d'État athénien)", "Hérodote (père de l'histoire)"] },
  ...
  { generation: 25, title: "Socrate et Hippocrate — Raison et Médecine", era: "Empires Anciens", icon: "🧪",
    ...
    figures: ["Socrate (père de la philosophie)", "Hippocrate (père de la médecine)"] },
  ...
  { generation: 26, title: "Platon, Aristote et Alexandre le Grand", era: "Empires Anciens", icon: "📚",
    ...
    figures: ["Platon (philosophe)", "Aristote (philosophe universel)"] },
  ...
  { generation: 27, title: "Archimède, Euclide et l'Empire Perse", era: "Empires Anciens", icon: "🔭",
    ...
    figures: ["Archimède (mathématicien et ingénieur)", "Euclide (père de la géométrie)"] },
  ...
  { generation: 28, title: "Rome — Jules César et Cléopâtre", era: "Empires Anciens", icon: "🏛️",
    ...
    figures: ["Jules César (général et réformateur)", "Cléopâtre VII (reine d'Égypte)"] },
  ...
  { generation: 29, title: "Issa — La Lumière de l'Amour", era: "Issa et le Christianisme", icon: "✨",
    ...
    figures: ["Jésus-Christ/Isa (Prophète)", "Marie/Maryam (mère de Jésus)"] },
  ...
  { generation: 30, title: "L'Église Primitive et l'Expansion Chrétienne", era: "Issa et le Christianisme", icon: "🕊️",
    ...
    figures: ["Pierre/Kephas (apôtre fondateur)", "Paul de Tarse (diffuseur de l'Évangile)"] },
  ...
  { generation: 31, title: "Rome Impériale — Marc Aurèle et la Médecine", era: "Issa et le Christianisme", icon: "⚕️",
    ...
    figures: ["Marc Aurèle (emperor philosophe)", "Galien (père de la médecine romaine)"] },
  ...
  { generation: 32, title: "Néoplatonisme et Zénobie de Palmyre", era: "Transitions Mondiales", icon: "🌙",
    ...
    figures: ["Plotin (philosophe néoplatonicien)", "Zénobie (reine de Palmyre)"] },
  ...
  { generation: 33, title: "Constantin et la Liberté Religieuse", era: "Transitions Mondiales", icon: "✝️",
    ...
    figures: ["Constantin Ier (premier emperor chrétien)", "Augustin d'Hippone (théologien, Algérie)"] },
  ...
  { generation: 34, title: "La Chute de Rome et Hypatia", era: "Transitions Mondiales", icon: "🕯️",
    ...
    figures: ["Jérôme (traducteur de la Bible)", "Hypatia d'Alexandrie (mathématicienne et philosophe)"] },
  ...
  { generation: 35, title: "Les Grandes Migrations et Saint Patrick", era: "Transitions Mondiales", icon: "🚶",
    ...
    figures: ["Attila (chef hun)", "Saint Patrick (évangélisateur d'Irlande)"] },
  ...
  { generation: 36, title: "Justinien — Le Droit et Sainte-Sophie", era: "Transitions Mondiales", icon: "🔵",
    ...
    figures: ["Justinien Ier (emperor byzantin)", "Théodora (impératrice cofondatrice)"] },
  ...
  { generation: 37, title: "Grégoire le Grand — Naissance de l'Islam en Préparation", era: "Naissance de l'Islam", icon: "🌙",
    ...
    figures: ["Grégoire le Grand (pape réformateur)", "Mahomet ibn Abdullah naît"] },
  ...
  { generation: 38, title: "Muhammad — La Révélation du Coran", era: "Naissance de l'Islam", icon: "📖",
    ...
    figures: ["Muhammad (saw) (Prophète, Sceau des Prophètes)", "Khadija bint Khuwaylid (première croyante)"] },
  ...
  { generation: 39, title: "Les Quatre Califes — L'Âge d'Or Initial", era: "Expansion Islamique", icon: "🌟",
    ...
    figures: ["Omar ibn al-Khattab (deuxième calife)", "Aisha bint Abi Bakr (grande savante islamique)"] },
  ...
  { generation: 40, title: "Les Omeyyades et l'Islam en Espagne", era: "Expansion Islamique", icon: "🕌",
    ...
    figures: ["Ali ibn Abi Talib (quatrième calife)", "Tariq ibn Ziyad (conquérant de l'Espagne)"] },
  ...
  { generation: 41, title: "Omar ibn Abd al-Aziz — Le Calife Juste", era: "Expansion Islamique", icon: "⚖️",
    ...
    figures: ["Omar ibn Abd al-Aziz (calife de justice)", "Al-Hasan al-Basri (fondateur du soufisme)"] },
  ...
  { generation: 42, title: "Bagdad — Capitale Mondiale du Savoir", era: "Expansion Islamique", icon: "🔭",
    ...
    figures: ["Jabir ibn Hayyan (père de la chimie)", "Haroun al-Rachid (calife abbasside)"] },
  ...
  { generation: 43, title: "Al-Khwarizmi — L'Algèbre et l'Algorithmique", era: "Expansion Islamique", icon: "🔢",
    ...
    figures: ["Al-Khwarizmi (père de l'algèbre)", "Al-Battani (astronome)"] },
  ...
  { generation: 44, title: "Ibn Sina — La Médecine Universelle", era: "Expansion Islamique", icon: "⚕️",
    ...
    figures: ["Ibn Sina/Avicenne (médecin universel)", "Al-Biruni (polymathe et géographe)"] },
  ...
  { generation: 45, title: "Al-Ghazali et les Croisades", era: "Rencontres des Civilisations", icon: "⚔️",
    ...
    figures: ["Al-Ghazali (philosophe soufi)", "Omar Khayyam (mathématicien et poète)"] },
  ...
  { generation: 46, title: "Sundiata Keïta — L'Empire du Mali", era: "Empires Africains", icon: "🦁",
    ...
    figures: ["Soundiata Keita (fondateur de l'Empire du Mali)", "Thomas d'Aquin (théologien universel)"] },
  ...
  { generation: 47, title: "Saladin et Maïmonide", era: "Rencontres des Civilisations", icon: "🌹",
    ...
    figures: ["Saladin (sultan libérateur de Jérusalem)", "Maïmonide (philosophe et médecin juif)"] },
  ...
  { generation: 48, title: "Gengis Khan et la Magna Carta", era: "Rencontres des Civilisations", icon: "🌍",
    ...
    figures: ["Gengis Khan (fondateur de l'Empire mongol)", "Rumi (poète soufi universel)"] },
  ...
  { generation: 49, title: "Mansa Moussa — Le Pèlerinage du Siècle", era: "Empires Africains", icon: "🕋",
    ...
    figures: ["Mansa Musa (emperor du Mali, plus riche homme)", "Ibn Battuta (plus grand voyageur du Moyen Âge)"] },
  ...
  { generation: 50, title: "Ibn Khaldoun — Le Père de la Sociologie", era: "Empires Africains", icon: "📚",
    ...
    figures: ["Ibn Khaldoun (père de la sociologie)", "Hafez de Chiraz (poète mystique)"] },
  ...
  { generation: 51, title: "Gutenberg et la Révolution de l'Imprimerie", era: "Rencontres des Civilisations", icon: "🖨️",
    ...
    figures: ["Johannes Gutenberg (inventeur de l'imprimerie)", "Léonard de Vinci (génie universel, 1452)"] },
  ...
  { generation: 52, title: "Colomb, Vasco de Gama et les Grandes Découvertes", era: "Colonisation", icon: "🚢",
    ...
    figures: ["Michel-Ange (artiste universel)", "Christophe Colomb (explorateur)"] },
  ...
  { generation: 53, title: "Luther et la Révolution Protestante", era: "Révolutions", icon: "📜",
    ...
    figures: ["Martin Luther (réformateur protestant)", "Copernic (révolution astronomique)"] },
  ...
  { generation: 54, title: "Galilée et Shakespeare", era: "Révolutions", icon: "🔭",
    ...
    figures: ["Galilée (astronome et physicien)", "William Shakespeare (dramaturge universel)"] },
  ...
  { generation: 55, title: "Descartes et Pascal — Le Rationalisme", era: "Révolutions", icon: "💭",
    ...
    figures: ["René Descartes (père du rationalisme)", "Blaise Pascal (mathématicien et philosophe)"] },
  ...
  { generation: 56, title: "Newton — La Gravitation Universelle", era: "Révolutions", icon: "🍎",
    ...
    figures: ["Isaac Newton (père de la physique classique)", "John Locke (père du libéralisme)"] },
  ...
  { generation: 57, title: "Les Lumières — Voltaire et Rousseau", era: "Révolutions", icon: "💡",
    ...
    figures: ["Bach (compositeur universel)", "Voltaire (philosophe des Lumières)"] },
  ...
  { generation: 58, title: "La Révolution Française et l'Indépendance Américaine", era: "Révolutions", icon: "🔵",
    ...
    figures: ["Toussaint Louverture (libérateur d'Haïti)", "Adam Smith (père de l'économie moderne)"] },
  ...
  { generation: 59, title: "Napoléon et Beethoven", era: "Révolutions", icon: "⚔️",
    ...
    figures: ["Napoléon Bonaparte (réformateur)", "Beethoven (compositeur universel)"] },
  ...
  { generation: 60, title: "Bolívar et Chaka Zoulou — Libérations", era: "Colonisation", icon: "🛡️",
    ...
    figures: ["Simón Bolívar (libérateur d'Amérique latine)", "Shaka Zulu (roi guerrier)"] },
  ...
  { generation: 61, title: "El Hadj Umar Tall et Victor Hugo", era: "Colonisation", icon: "📖",
    ...
    figures: ["El Hadj Oumar Tall (résistant africain)", "Victor Hugo (écrivain universel)"] },
  ...
  { generation: 62, title: "Lincoln, Darwin et Marie Curie", era: "Révolutions", icon: "⚗️",
    ...
    figures: ["Abraham Lincoln (président abolitionniste)", "Harriet Tubman (héroïne de la liberté)"] },
  ...
  { generation: 63, title: "Samori Touré — La Résistance Héroïque", era: "Colonisation", icon: "⚔️",
    ...
    figures: ["Samori Touré (héros de la résistance africaine)", "Mendeleïev (tableau périodique 1869)"] },
  ...
  { generation: 64, title: "Edison, Tesla et Marie Curie", era: "Révolutions", icon: "⚡",
    ...
    figures: ["Thomas Edison (inventeur)", "Marie Curie (première femme prix Nobel)"] },
  ...
  { generation: 65, title: "Einstein, Gandhi et la Grande Guerre", era: "Guerres Mondiales", icon: "🌍",
    ...
    figures: ["Einstein (physicien révolutionnaire)", "Gandhi (pionnier de la non-violence)"] },
  ...
  { generation: 66, title: "La Négritude et le Panafricanisme", era: "Luttes pour la Liberté", icon: "✊",
    ...
    figures: ["Léopold Sédar Senghor (fondateur de la Négritude)", "Marcus Garvey (leader panafricain)"] },
  ...
  { generation: 67, title: "Nkrumah et l'Année de l'Afrique", era: "Indépendances", icon: "🌍",
    ...
    figures: ["Kwame Nkrumah (père du Ghana indépendant)", "Patrice Lumumba (martyr congolais)"] },
  ...
  { generation: 68, title: "Martin Luther King — Je Fais un Rêve", era: "Luttes pour la Dignité", icon: "🕊️",
    ...
    figures: ["Martin Luther King (leader des droits civiques)", "Nelson Mandela (emprisonné, symbole de résistance)"] },
  ...
  { generation: 69, title: "Sékou Touré — Non à la France", era: "Indépendances", icon: "✊",
    ...
    figures: ["Sékou Touré (leader guinéen)", "Thomas Sankara (révolutionnaire burkinabé)"] },
  ...
  { generation: 70, title: "Mandela Libéré — La Réconciliation", era: "Luttes pour la Dignité", icon: "🌈",
    ...
    figures: ["Nelson Mandela (président réconciliateur)", "Desmond Tutu (prix Nobel de la paix)"] },
  ...
  { generation: 71, title: "Sembène Ousmane — Le Cinéma Africain", era: "Luttes pour la Dignité", icon: "🎬",
    ...
    figures: ["Amadou Hampâté Bâ (gardien des traditions)", "Sembène Ousmane (père du cinéma africain)"] },
  ...
  { generation: 72, title: "Internet — La Révolution de l'Information", era: "Ère Numérique", icon: "🌐",
    ...
    figures: ["Tim Berners-Lee (inventeur du Web)", "Mae Jemison (première femme noire dans l'espace)"] },
  ...
  { generation: 73, title: "Barack Obama et le Printemps Arabe", era: "Ère Numérique", icon: "🇺🇸",
    ...
    figures: ["Barack Obama (premier président afro-américain)", "Malala Yousafzai (défenseuse de l'éducation)"] },
  ...
  { generation: 74, title: "COVID-19 — L'Humanité à l'Épreuve", era: "Ère Numérique", icon: "🦠",
    ...
    figures: ["Maryam Mirzakhani (première Médaille Fields féminine)", "Simone Biles (athlète universelle)"] },
  ...
  { generation: 75, title: "L'Afrobeats Conquiert le Monde", era: "Présent", icon: "🎵",
    ...
    figures: ["Burna Boy (artiste global)", "Ngozi Okonjo-Iweala (directrice de l'OMC)"] },
  ...
  { generation: 76, title: "Black Lives Matter et la Littérature Africaine", era: "Présent", icon: "✊",
    ...
    figures: ["Leïla Slimani (écrivaine primée)", "Chimamanda Adichie (voix féministe africaine)"] },
  ...
  { generation: 77, title: "La Jeunesse Africaine en Marche", era: "Présent", icon: "📈",
    ...
    figures: ["Nouvelles figures politiques africaines", "Entrepreneurs tech africains"] },
  ...
  { generation: 78, title: "La Guinée — Culture et Rayonnement", era: "Présent", icon: "🎶",
    ...
    figures: ["Famoudou Konaté (maître mondial du djembé)", "Artistes du Ballet National de Guinée"] },
  ...
  { generation: 79, title: "Les Résistants Africains du XIXe Siècle", era: "Colonisation", icon: "🛡️",
    ...
    figures: ["El Hadj Oumar Tall (réformateur islamique)", "Thierno Aliou Bah (grand savant guinéen)"] },
  ...
  { generation: 80, title: "Menelik II — La Victoire d'Adoua", era: "Colonisation", icon: "⚔️",
    ...
    figures: ["Samori Touré (héros de la résistance)", "Menelik II (roi d'Éthiopie, vainqueur d'Adoua)"] },
  ...
  { generation: 81, title: "Ahmadou Bamba — La Résistance Spirituelle", era: "Luttes pour la Liberté", icon: "🌙",
    ...
    figures: ["Cheikh Ahmadou Bamba (résistance spirituelle)", "Marcus Garvey (panafricaniste)"] },
  ...
  { generation: 82, title: "W.E.B. Du Bois et le Mouvement pour les Droits", era: "Luttes pour la Liberté", icon: "✊",
    ...
    figures: ["W.E.B. Du Bois (intellectuel et militant)", "Gandhi (pionnier de la non-violence)"] },
  ...
  { generation: 83, title: "Les Indépendances Asiatiques", era: "Indépendances", icon: "🌏",
    ...
    figures: ["Atatürk (père de la Turquie moderne)", "Ho Chi Minh (résistant vietnamien)"] },
  ...
  { generation: 84, title: "Fanon, Nyerere et les Architectes Africains", era: "Indépendances", icon: "🏗️",
    ...
    figures: ["Frantz Fanon (théoricien de la décolonisation)", "Julius Nyerere (père de la Tanzanie)"] },
  ...
  { generation: 85, title: "Senghor et les Arts Africains Universels", era: "Luttes pour la Dignité", icon: "🎨",
    ...
    figures: ["Léopold Sédar Senghor (poète et président)", "Seydou Keïta (photographe de l'Afrique)"] },
  ...
  { generation: 86, title: "Youssou N'Dour et la Musique Africaine Mondiale", era: "Luttes pour la Dignité", icon: "🎶",
    ...
    figures: ["Youssou N'Dour (voix de l'Afrique)", "Fela Kuti (créateur de l'Afrobeat)"] },
  ...
  { generation: 87, title: "Sékou Touré et la Construction de la Guinée", era: "Indépendances", icon: "🇬🇳",
    ...
    figures: ["Sékou Touré (père de l'indépendance guinéenne)", "Modibo Keïta (premier président du Mali)"] },
  ...
  { generation: 88, title: "Mandela et la Réconciliation en Afrique du Sud", era: "Luttes pour la Dignité", icon: "🌈",
    ...
    figures: ["Nelson Mandela (président réconciliateur)", "Desmond Tutu (Commission Vérité et Réconciliation)"] },
  ...
  { generation: 89, title: "Soyinka, Achebe — La Littérature Africaine Universelle", era: "Luttes pour la Dignité", icon: "📖",
    ...
    figures: ["Wole Soyinka (premier Nobel africain de littérature)", "Chinua Achebe (romancier universel)"] },
  ...
  { generation: 90, title: "Kofi Annan et la Diplomatie Africaine", era: "Luttes pour la Dignité", icon: "🌍",
    ...
    figures: ["Kofi Annan (secrétaire général de l'ONU)", "Ellen Johnson Sirleaf (première présidente africaine)"] },
  ...
  { generation: 91, title: "Obama, Adichie et la Génération Connectée", era: "Ère Numérique", icon: "💻",
    ...
    figures: ["Barack Obama (premier président afro-américain)", "Chimamanda Adichie (romancière féministe)"] },
  ...
  { generation: 92, title: "L'Afrobeats Domine les Charts Mondiaux", era: "Présent", icon: "🎤",
    ...
    figures: ["Burna Boy (artiste mondial)", "Timnit Gebru (chercheuse en IA éthique)"] },
  ...
  { generation: 93, title: "L'Intelligence Artificielle et le Défi Climatique", era: "Présent", icon: "🤖",
    ...
    figures: ["Maryam Mirzakhani (première Médaille Fields féminine)", "Greta Thunberg (militante climatique)"] },
  ...
  { generation: 94, title: "L'Union Africaine et la Renaissance Panafricaine", era: "Présent", icon: "🤝",
    ...
    figures: ["Ngozi Okonjo-Iweala (à l'OMC)", "Fatoumata Diawara (voix africaine mondiale)"] },
  ...
  { generation: 95, title: "Les Enfants d'Adam — Une Seule Humanité", era: "Présent", icon: "🌍",
    ...
    figures: ["Toutes les femmes et hommes de bonne volonté", "Les enfants d'Adam de chaque nation"] },
];
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-5">
              {filteredHistorical.map(entry => (
                ...
                >
                  ...
                  {/* Description courte */}
                  <p className="text-gray-600 text-sm mb-4 flex-1 line-clamp-3">{entry.content}</p>

                  {/* Événements & figures */}
                  <div className="space-y-1 border-t border-gray-100 pt-3">
                    {entry.keyEvents.slice(0, 2).map((ev, i) => (
                      <p key={i} className="text-xs text-gray-500 flex items-start gap-1.5">
                        <span>📅</span><span className="line-clamp-1">{ev}</span>
                      </p>
                    ))}
                    {entry.figures.slice(0, 1).map((fig, i) => (
                      <p key={i} className="text-xs text-amber-700 flex items-start gap-1.5">
                        <span>👑</span><span className="line-clamp-1">{fig}</span>
                      </p>
                    ))}
                  </div>
                </div>
          ...
          {loading ? (
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-5">
              {filteredStories.map(story => (
                <div key={story.id}
                  className="bg-white rounded-xl border-l-4 border-indigo-500 shadow-sm hover:shadow-md transition-all duration-200 overflow-hidden">
                  {/* Header */}
                  <div className="bg-gradient-to-r from-indigo-600 to-blue-600 p-5">
                    <div className="flex items-start justify-between">
                      <div className="flex items-center gap-3">
                        <span className="text-3xl">{sectionIcons[story.sectionId] || '📖'}</span>
                        <div>
                          <div className="flex items-center gap-2 mb-1 flex-wrap">
                            <span className="text-xs font-bold bg-white/20 text-white px-2 py-0.5 rounded-full">📖 Récit personnel</span>
                            {story.generation && <span className="text-xs bg-white/20 text-white/90 px-2 py-0.5 rounded-full">{story.generation}</span>}
                          </div>
                          <h3 className="text-base font-bold text-white">{story.sectionTitle}</h3>
                          <p className="text-indigo-100 text-xs mt-0.5">
                            {story.authorName} raconte sa propre histoire{story.region && ` • ${story.region}`}
                          </p>
                        </div>
                      </div>
                      <div className="text-right text-white text-xs flex-shrink-0">
                        <div className="text-indigo-100">Publié le</div>
                  ...
                  <div className="p-5">
                    <p className="text-gray-700 text-sm leading-relaxed mb-4 whitespace-pre-wrap">
                      {story.content.length > 400 ? `${story.content.substring(0, 400)}...` : story.content}
                    </p>
                    {story.photos && story.photos.length > 0 && (
                      <div className="grid grid-cols-2 gap-2 mb-4">
                        {story.photos.slice(0, 4).map((photo, i) => (
                          <img key={i} src={mediaSrc(photo)} alt="" className="w-full h-28 object-cover rounded-lg cursor-pointer" onClick={() => setSelectedStory(story)} />
                        ))}
                      </div>
                    )}
                    {story.videos && story.videos.length > 0 && (
                      <div className="space-y-2 mb-4">
                        {story.videos.map((v, i) => <video key={i} src={mediaSrc(v)} controls className="w-full rounded-lg" />)}
                      </div>
                    )}
                      ...
                      <div className="flex items-center justify-between mb-2">
                        ...
                        <div className="flex items-center gap-1">
                          ...
                          {currentUserNumeroH && currentUserNumeroH !== story.numeroH && (
                            !(story.witnesses || []).some(w => w.numeroH === currentUserNumeroH) && (story.witnesses?.length || 0) < 4 ? (
                              <button onClick={() => handleTestify(story.id)} disabled={testifyingId === story.id}
                    ...
                    <div className="flex items-center justify-between pt-3 mt-1 border-t border-gray-100">
                      <span className="text-xs text-gray-400">👁️ {story.views} vues</span>
                      {story.content.length > 400 && (
                        <button onClick={() => setSelectedStory(story)} className="text-indigo-600 text-sm font-semibold hover:text-indigo-700">Lire la suite →</button>
                      )}
                    </div>
                  </div>
                </div>
