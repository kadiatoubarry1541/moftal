  ...
  return (
    <div style={{ maxWidth: 900, margin: "0 auto", padding: "24px 16px", fontFamily: "system-ui,sans-serif" }}>
      <DynamicAppManifest
        ...
        description={`Gestion entreprise — ${tenant?.name || ""}`}
        startUrl={`/gestion-entreprise/${tenantCode}`}
        themeColor={INDIGO}
      />
      ...
      <div style={{ background: `linear-gradient(135deg,#4338ca,#7c3aed)`, borderRadius: 16, padding: "20px 24px", marginBottom: 24, display: "flex", alignItems: "center", gap: 16 }}>
        ...
        <div style={{ flex: 1, minWidth: 0, overflow: "hidden" }}>
          <div style={{ fontWeight: 800, color: "white", fontSize: 20, overflow: "hidden", textOverflow: "ellipsis", whiteSpace: "nowrap" }}>{tenant?.name || "Entreprise"}</div>
        ...
        <div style={{ display: "flex", gap: 8, flexShrink: 0 }}>
          ...
          <button className="gestion-btn-secondary" onClick={() => navigate(`/entreprise/${tenantCode}`)} style={{ background: "rgba(255,255,255,0.15)", color: "white", border: "1px solid rgba(255,255,255,0.3)", borderRadius: 8, padding: "8px 14px", cursor: "pointer", fontSize: 12, fontWeight: 600 }}>🌐 Vitrine</button>
