...
export default function Producteurs() {
  ...
  return (
    <div className="max-w-4xl mx-auto px-4 py-4">
      ...
      <div className="mb-6 flex items-center gap-3 rounded-2xl bg-lime-600 px-4 py-3 text-white shadow-md">
        <span className="text-3xl leading-none">🌾</span>
        <div>
          <h1 className="text-base font-bold leading-tight">Producteurs</h1>
          <p className="text-xs text-lime-100 mt-0.5">
            Producteurs locaux — filtrez par ville, quartier ou pays
          </p>
        </div>
      </div>

      <p className="text-sm text-gray-600 mb-4">
        Retrouvez ici les <strong>producteurs approuvés</strong>. Filtrez par{' '}
      ...
      <ProSection
        ...
        title="Producteurs"
        icon="🌾"
        description="Producteurs et agriculteurs disponibles dans votre région."
      />
