    ...
    <div style={{ maxWidth:960, margin:"0 auto", padding:"0 0 60px" }}>
      ...
      <div style={{ background:"linear-gradient(135deg,#3730a3,#4338ca)", padding:"28px 28px 0" }}>
        <div style={{ display:"flex", alignItems:"center", gap:14, marginBottom:20 }}>
          ...
          <div style={{ flex:1 }}>
            <div style={{ fontWeight:800, color:"white", fontSize:20 }}>{tenant?.name || "Scientifiques"}</div>
            <div style={{ fontSize:12, color:"rgba(255,255,255,0.75)", marginTop:2 }}>Code : {tenantCode} · Scientifiques & Recherche</div>
          </div>
          <div style={{ display:"flex", gap:8 }}>
            <button onClick={() => navigate(`/scientifique/${tenantCode}`)} style={{ background:"rgba(255,255,255,0.15)", color:"white", border:"1px solid rgba(255,255,255,0.3)", borderRadius:8, padding:"8px 14px", cursor:"pointer", fontWeight:600, fontSize:13 }}>🌐 Vitrine</button>
