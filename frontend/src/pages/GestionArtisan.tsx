  ...
  return (
    <div style={{ maxWidth: 1100, margin: "0 auto", padding: "16px", fontFamily: "system-ui,sans-serif" }}>
      <DynamicAppManifest
        ...
        description={`Gestion artisan — ${tenant?.name || ""}`}
        startUrl={`/gestion-artisan/${tenantCode}`}
        themeColor={COLOR}
      />
      ...
      <div style={{ background: GRADIENT, borderRadius: 16, padding: "24px 28px", marginBottom: 24, color: "white" }}>
        <div style={{ display: "flex", alignItems: "center", gap: 12 }}>
          ...
          <div style={{ flex: 1, minWidth: 0, overflow: "hidden" }}>
            <h1 style={{ margin: 0, fontSize: 22, fontWeight: 700, overflow: "hidden", textOverflow: "ellipsis", whiteSpace: "nowrap" }}>{tenant?.name || "Artisanat & Services"}</h1>
